...
const FileDropzone: React.FC<DropzoneProps> = ({ onDrop, uploading }) => {
...
const RecentUploads: React.FC<RecentUploadsProps> = ({ documents, isLoading, onDelete, deleting }) => (
  <>
...
const DocumentUploader: React.FC = () => {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <FileDropzone onDrop={handleFileDrop} uploading={uploading} />
        <RecentUploads
          documents={documents}
          isLoading={isLoading}
